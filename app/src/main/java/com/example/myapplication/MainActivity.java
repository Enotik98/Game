...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void updateField() {
        ...
        for (int i = 0; i < 8; ++i)
            for (int j = 0; j < 8; ++j) {
                switch (field[i][j]) {
                    case RED:
                        imageField[i][j].setImageResource(R.drawable.red_un);
                        break;
                    case BLUE:
                        imageField[i][j].setImageResource(R.drawable.blue_un);
                        break;
                    case GREEN:
                        imageField[i][j].setImageResource(R.drawable.green_un);
                        break;
                    case MAG:
                        imageField[i][j].setImageResource(R.drawable.mag_un);
                        break;
                    case -RED:
    ...
    public void displaySelected() {
        ...
        switch (field[from.row][from.col]) {
            case RED:
                imageField[from.row][from.col].setImageResource(R.drawable.red_sel);
                break;
            case BLUE:
                imageField[from.row][from.col].setImageResource(R.drawable.blue_sel);
                break;
            case GREEN:
                imageField[from.row][from.col].setImageResource(R.drawable.green_sel);
                break;
            case MAG:
                imageField[from.row][from.col].setImageResource(R.drawable.mag_sel);
                break;
        }
    ...
    public void revertSelected() {
        ...
        switch (field[from.row][from.col]) {
            case RED:
                imageField[from.row][from.col].setImageResource(R.drawable.red_un);
                imageField[from.row][from.col].setVisibility(View.VISIBLE);
                break;
            case BLUE:
                imageField[from.row][from.col].setImageResource(R.drawable.blue_un);
                imageField[from.row][from.col].setVisibility(View.VISIBLE);
                break;
            case GREEN:
                imageField[from.row][from.col].setImageResource(R.drawable.green_un);
                imageField[from.row][from.col].setVisibility(View.VISIBLE);
                break;
            case MAG:
                imageField[from.row][from.col].setImageResource(R.drawable.mag_un);
                imageField[from.row][from.col].setVisibility(View.VISIBLE);
                break;
            case 0:
